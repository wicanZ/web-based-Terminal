...
export default {
    execute: async function(args, terminal) {
        ...
        const locations = {
            start: {
                description: 'You are at the start of your adventure. There is a path to the north.',
                exits: { north: 'forest' }
            },
            forest: {
                description: 'You are in a dense forest. Paths lead to the south and east.',
                exits: { south: 'start', east: 'cave' }
            },
            cave: {
                description: 'You are in a dark cave. A path leads west back to the forest. There is a treasure chest here.',
                exits: { west: 'forest' }
            }
        };
    ...
    description: 'Play a simple text-based adventure game.'
};
